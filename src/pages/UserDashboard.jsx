...
import Header from '../components/ui/header';
import Footer from '../components/ui/footer';
import { Loader2, Github, Brain, Pencil, Upload, CheckCircle, Clock, XCircle } from "lucide-react";
import { toast } from 'react-toastify';
          ...
          if (finalDecision === 'accepted') {
            return (
              <div className="mt-2 flex items-center gap-2 text-green-600 bg-green-50 px-3 py-2 rounded-lg">
                <CheckCircle className="w-4 h-4" />
                <p className="font-medium">🎉 Congratulations! You have been accepted!</p>
              </div>
            );
            ...
            return (
              <div className="mt-2 flex flex-col gap-2">
                <div className="flex items-center gap-2 text-red-600 bg-red-50 px-3 py-2 rounded-lg">
                  ...
                  <p className="font-medium">Not selected for this position</p>
                </div>
                <button
                  onClick={() => navigate('/career')}
                  className="text-sm text-purple-600 hover:text-purple-800 underline"
                >
                  View feedback in Career Dashboard →
                </button>
              </div>
            );
          } else {
